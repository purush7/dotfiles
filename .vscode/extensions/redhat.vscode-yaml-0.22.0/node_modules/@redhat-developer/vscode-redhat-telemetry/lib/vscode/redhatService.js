...
function getRedHatService(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const builder = new __1.TelemetryServiceBuilder(packageJson)
            ...
            .setEnvironment(yield platform_node_1.getEnvironment(extensionId, packageJson.version));
...
function getExtension(context) {
    ...
    const packageJson = extensions_1.loadPackageJson(context.extensionPath);
    const info = {
        id: extensions_1.getExtensionId(packageJson),
