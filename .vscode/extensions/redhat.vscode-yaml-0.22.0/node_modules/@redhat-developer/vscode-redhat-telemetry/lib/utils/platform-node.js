...
exports.COUNTRY = getCountry(exports.TIMEZONE);
exports.UI_KIND = getUIKind();
exports.USERNAME = getUsername();
function getCountry(timezone) {
    const tz = countries_and_timezones_1.getTimezone(timezone);
...
function getDistribution() {
    return __awaiter(this, void 0, void 0, function* () {
        if (os.platform() === 'linux') {
            const platorm = yield util_1.promisify(getos_1.default)();
            return platorm.dist;
        }
        return undefined;
    });
