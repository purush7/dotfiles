...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const telemetry = yield (yield vscode_redhat_telemetry_1.getRedHatService(context)).getTelemetryService();
        ...
        const telemetryErrorHandler = new telemetry_1.TelemetryErrorHandler(telemetry, lsName, 4);
        const outputChannel = vscode_1.window.createOutputChannel(lsName);
        ...
        const clientOptions = {
            ...
            outputChannel: new telemetry_1.TelemetryOutputChannel(outputChannel, telemetry),
        };
