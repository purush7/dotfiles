...
class RSTPreview {
    ...
    async doUpdate() {
        ...
        const content = await this._contentProvider.provideTextDocumentContent(document, this._previewConfigurations, this.editor.webview, this.line, this.state);
