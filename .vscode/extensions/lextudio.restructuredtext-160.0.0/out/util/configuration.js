...
class Configuration {
    ...
    static getSyntaxHighlightingDisabled(resource = null) {
    ...
    static async setSyntaxHighlightingDisabled(resource = null) {
    ...
    static GetRootPath(resource) {
        var _a;
        if (!vscode_1.workspace.workspaceFolders) {
            return (_a = vscode_1.workspace.rootPath) !== null && _a !== void 0 ? _a : path.dirname(resource.fsPath);
        }
        let root;
        if (vscode_1.workspace.workspaceFolders.length === 1) {
            root = vscode_1.workspace.workspaceFolders[0];
